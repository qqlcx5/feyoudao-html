function showTime() { 
	...
	var startDate = new Date(2020, 4 ,8);
	...
	var currentTimeString = "Dear :<br>"
		...
		+ "<c style=\"color: #CCFF99; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:24px\" >" + days +" </c>18day " 
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----love you   2020-4-8</c>"; 
